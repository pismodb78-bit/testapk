...
object Prefs {
    ...
    /**
     * Качество демонстрации экрана: 0 — экономно, 1 — чётко, 2 — плавно.
     *
     * По умолчанию «чётко»: у демонстрации почти всегда показывают интерфейс
     * и текст, и там важнее разрешение, чем частота кадров. WebRTC при
     * нехватке канала для демонстрации сам жертвует кадрами, а не чёткостью
    ...
    var screenShareQuality: Int
        get() = sp.getInt("screen_share_quality", 1)
